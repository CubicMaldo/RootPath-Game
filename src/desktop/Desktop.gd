...
func _on_game_over(_won: bool):
	...
	_show_banner("[b]Raíz restaurada[/b]\nEl último nodo quedó libre de malware. Respira: has devuelto la luz a la red.", 7.0, Color(0.4, 1.0, 0.8))
